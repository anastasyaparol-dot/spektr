...
function mainMenu() {
  return {
    keyboard: [
      ...
      [{ text: '👟 Экипировка с ИИ помощником' }, { text: '🎽 Хочу в клуб СПЕКТР' }],
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ── Клуб СПЕКТР ──
    if (text === '🎽 Хочу в клуб СПЕКТР') {
      await send(chatId, `🎽 <b>Беговой клуб СПЕКТР</b>

<b>Индивидуальное тренерское ведение</b> — это:

📋 <b>Персональный план</b> под твой уровень, цели и расписание
💬 <b>Постоянная связь с тренером</b> и разбор каждой тренировки
📊 <b>Анализ данных</b>: пульс, темп, динамика прогресса
🎯 <b>Подготовка к забегам</b> — от 5 км до ультра

<b>Чего можно достичь:</b>
— −15 минут на марафоне за сезон
— Первый финиш полумарафона за 3 месяца с нуля
— Личный рекорд на любой дистанции
— Бег без травм и перетренированности

<b>Для кого:</b>
🏃 Только начинаешь и хочешь сделать всё правильно
🏅 Бегаешь, но застрял на одном уровне
🌲 Интересует трейл, ультра или Backyard Ultra

👉 Напиши тренеру: @maksromanovrun`, { reply_markup: mainMenu() })
      return res.status(200).end()
    }
